(function(root, factory) {
 ...
 'use strict';
  ...
  /**
   * main method.. returns a object that built with default values from json schema
   * second argument is not mandatory. If it is not present definitions will be taken from schema
   * @param {Object} schema
   * @param {Object} definitions
   * @return {Object}
   */
